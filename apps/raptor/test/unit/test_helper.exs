...
Mox.defmock(DatasetAccessGroupRelationStoreMock,
  for: Raptor.Services.DatasetAccessGroupRelationStoreBehaviour
)

Mox.defmock(UserAccessGroupRelationStoreMock,
  for: Raptor.Services.UserAccessGroupRelationStoreBehaviour
)
