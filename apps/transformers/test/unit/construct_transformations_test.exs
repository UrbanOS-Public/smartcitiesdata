defmodule Transformers.ConstructTest do
  ...
  test "when given 1 transformation, builds a list of 1 operation" do
    ...
    regex_transformation = Transformation.new(%{type: "regex_extract", name: "Transformation", parameters: regex_params})
  ...
  test "when given 3 transformations, builds a list of 3 operations" do
    ...
    regex_transformation1 = Transformation.new(%{type: "regex_extract", name: "Transformation", parameters: regex_params})
    regex_transformation2 = Transformation.new(%{type: "regex_extract", name: "Transformation", parameters: regex_params})
    regex_transformation3 = Transformation.new(%{type: "regex_extract", name: "Transformation", parameters: regex_params})
