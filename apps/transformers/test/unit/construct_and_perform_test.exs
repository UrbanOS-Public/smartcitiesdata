defmodule Transformers.ConstructAndPerformTest do
  ...
  test "two transforms of same kind" do
    ...
    transformation1 = Transformation.new(%{type: "regex_extract", name: "Transformation", parameters: parameters})
    ...
    transformation2 = Transformation.new(%{type: "regex_extract", name: "Transformation", parameters: parameters})
  ...
  test "two transforms of different kinds" do
    ...
    transformation1 = Transformation.new(%{type: "regex_extract", name: "Transformation", parameters: regex_params})
    ...
    transformation2 = Transformation.new(%{type: "conversion", name: "Transformation", parameters: conversion_params})
