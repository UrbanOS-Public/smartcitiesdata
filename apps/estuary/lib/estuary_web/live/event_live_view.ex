defmodule EstuaryWeb.DatasetLiveView do
  use Phoenix.LiveView
  alias EstuaryWeb.Router.Helpers, as: Routes
  alias EstuaryWeb.DatasetLiveView.Table
  ...
  def mount(_session, socket) do
    EstuaryWeb.Endpoint.subscribe(@ingested_time_topic)
