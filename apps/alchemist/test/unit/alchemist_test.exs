defmodule AlchemistTest do
  ...
  describe "standardize_data/1" do
    data_test "validates that #{value} is a valid #{type}" do
      ...
      assert {:ok, payload} == Alchemist.standardize_data(dataset, payload)
    ...
    data_test "transforms #{value} to a valid #{type}" do
      ...
      assert {:ok, %{field_name => transformed_value}} === Alchemist.standardize_data(dataset, %{field_name => value})
    ...
    data_test "transforms #{value} to a valid #{type} with format #{format}" do
      ...
      assert {:ok, expected} == Alchemist.standardize_data(dataset, payload)
    ...
    data_test "validates that #{value} with format #{format} is not a valid #{type}" do
      ...
      assert {:error, reason} == Alchemist.standardize_data(dataset, %{"birthdate" => value})
    ...
    data_test "validates that #{value} is a not a valid #{type}" do
      ...
      assert expected == Alchemist.standardize_data(dataset, %{field_name => value})
    ...
    data_test "validates that an empty string is a valid #{type}" do
      ...
      assert {:ok, %{field_name => nil}} == Alchemist.standardize_data(dataset, %{field_name => ""})
    ...
    test "an empty string of type string should not be converted to nil" do
      ...
      assert {:ok, %{"empty_string" => ""}} == Alchemist.standardize_data(dataset, %{"empty_string" => ""})
    end
    ...
    test "transforms valid values in a map" do
      ...
      assert expected == Alchemist.standardize_data(dataset, payload)
    end
    ...
    test "returns error that identifies unknown schema type" do
      ...
      assert {:error, %{"geometry" => :invalid_type}} == Alchemist.standardize_data(dataset, payload)
    end
  end
  ...
  describe "json is converted" do
    ...
    test "invalid json" do
      ...
      assert {:error, %{"geometry" => :invalid_json}} == Alchemist.standardize_data(dataset, payload)
    end
  end
end
