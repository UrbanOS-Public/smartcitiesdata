defmodule Andi.InputSchemas.Datasets do
  ...
  def update_latest_dlq_message(dataset_id, dlq_message) do
    case get(dataset_id) do
      nil -> Logger.info("Message does not pertain to any andi dataset: #{inspect(dlq_message)}")
      dataset -> update(dataset, %{dlq_message: dlq_message})
    end
  end
