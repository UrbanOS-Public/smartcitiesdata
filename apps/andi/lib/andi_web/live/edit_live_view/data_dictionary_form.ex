defmodule AndiWeb.EditLiveView.DataDictionaryForm do
  ...
  def handle_event("file_upload", %{"fileType" => file_type}, socket) when file_type not in ["text/csv", "application/json", "application/vnd.ms-excel"] do
    new_changeset =
  ...
  def handle_event("file_upload", %{"file" => file, "fileType" => file_type}, socket) when file_type in ["text/csv", "application/vnd.ms-excel"] do
