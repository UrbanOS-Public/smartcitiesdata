defmodule AndiWeb.EditLiveView.FinalizeForm do
  ...
  def render(assigns) do
    ...
    ~L"""
    <div id="<%= @id %>" class="finalize-form">
      <div class="component-header">
        <h3 class="component-section-number">4</h3>
        <h2 class="component-section-title component--expanded full-width"">Finalize</h2>
      </div>

      <div class="finalize-form-edit-section form-section">
