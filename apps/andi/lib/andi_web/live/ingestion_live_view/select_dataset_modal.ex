defmodule AndiWeb.IngestionLiveView.SelectDatasetModal do
  ...
  def render(assigns) do
    ...
    <div class="btn-group__standard">
          <button id="save-dataset-search-button" name="save-dataset-search-button" class="btn btn--primary-outline btn--large save-search" type="button" phx-click="save-dataset-search" phx-value-id=<%= @selected_dataset %>>  Save</button>
        </div>
      </div>
    </div>
    """
