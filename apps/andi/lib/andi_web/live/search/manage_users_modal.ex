defmodule AndiWeb.Search.ManageUsersModal do
  ...
  #         <div class="selected-result-from-search"><span class="selected-result-text"><%= dataset.business.dataTitle %></span><i class="material-icons remove-selected-result" phx-click="remove-selected-result" phx-value-id=<%= dataset.id %>>close</i></div>
  #       <% end %>
  #     </div>
  # </div>
