      ...
      <div class="edit-page" id="dataset-edit-page">
        ...
        <div id="data-dictionary-form" class="form-component">
          ...
          <div class="form-section">
            <div class="component-edit-section--<%= @component_visibility["data_dictionary_form"] %>">
        ...
        <div class="url-form-component">
          <%= live_component(@socket, AndiWeb.EditLiveView.UrlForm, id: :url_form_editor, technical: technical, testing: @testing, test_results: @test_results, save_success: @save_success, has_validation_errors: @has_validation_errors, page_error: @page_error, visibility: @component_visibility["url_form"]) %>
        </div>

        <div class="finalize-form-component ">
          <%= live_component(@socket, AndiWeb.EditLiveView.FinalizeForm, id: :finalize_form, dataset_id: dataset_id, form: technical, save_success: @save_success, has_validation_errors: @has_validation_errors, page_error: @page_error, visibility: @component_visibility["finalize_form"]) %>
