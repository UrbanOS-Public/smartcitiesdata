defmodule Reaper.VaultTokenDebugger do
  ...
  def print_vault_config do
    ...
    #secrets_endpoint = Application.get_env(:reaper, Reaper.SecretRetriever)[:secrets_endpoint]
    t1 = System.get_env("SECRETS_ENDPOINT")
    secrets_endpoint = "http://#{t1}"
...
#  Reaper.VaultTokenDebugger.debug_vault_token()
