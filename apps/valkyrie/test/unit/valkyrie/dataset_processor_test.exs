defmodule Valkyrie.DatasetProcessorTest do
  ...
  describe "start/1" do
    setup do
      ...
      %{dataset_id: "some-id", input_topic: topics.input_topic, output_topic: topics.output_topic}
    end

    test "should setup topics", setup_params do
      Valkyrie.DatasetProcessor.start(setup_params.dataset_id)

      assert_called(Valkyrie.TopicManager.setup_topics(setup_params.dataset_id))
    end
    ...
    test "should start a new DatasetSupervisor", setup_params do
      ...
      assert setup_params.dataset_id == Keyword.get(start_options, :dataset_id)
    ...
    test "should delete the dataset and the topics", setup_params do
      Valkyrie.DatasetProcessor.delete(setup_params.dataset_id)
      assert_called(Valkyrie.TopicManager.delete_topics(setup_params.dataset_id))
    end
  end
end
