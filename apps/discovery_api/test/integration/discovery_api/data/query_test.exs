defmodule DiscoveryApi.Data.QueryTest do
  ...
  test "Queries limited data from presto", %{conn: conn} do
    actual =
  ...
  @moduletag capture_log: true
  test "Queries data from presto with multiple clauses", %{conn: conn} do
    actual =
  ...
  @moduletag capture_log: true
  test "Queries data from presto with an aggregator", %{conn: conn} do
    actual =
