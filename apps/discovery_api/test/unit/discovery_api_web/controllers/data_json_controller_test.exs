  ...
  setup do
    ...
    public_model =
      Helper.sample_model(%{
        ...
        conformsToUri: "http://example.org/conformsto",
        describedByUrl: "http://example.org/describedby",
        describedByMimeType: "some mime type (describe)",
        parentDataset: "parentDataset",
        issuedDate: "issueddate",
        language: "english or spanish or something",
        referenceUrls: ["http://example.org/ref1", "http://example.org/ref2"],
  ...
  describe "GET with only required fields" do
    ...
    test "drops optional fields with nil value", %{conn: conn} do
      model = %Model{
        ...
        contactName: "Bob Jones",
        contactEmail: "bjones@example.com",
        license: "http://openlicense.org/licenses/some-license",
        private: false
      }
