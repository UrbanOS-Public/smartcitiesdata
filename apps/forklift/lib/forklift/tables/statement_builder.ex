defmodule Forklift.Tables.StatementBuilder do
  @moduledoc """
  Parses a dataset schema into a valid CREATE TABLE statement.
  """
  require Logger
  ...
  def build_table_create_statement(table_name, schema) do
    {:ok, translate_schema(table_name, schema)}
  rescue
    e in FieldTypeError ->
      {:error, e.message}
  ...
  defp translate_schema(name, schema) do
